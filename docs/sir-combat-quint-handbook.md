...
uses cannot identify a model symbol reliably. Eleven isolated mutations prove missing fragments, duplicate
...
declarations, rule-ID drift across model/runtime, and manifest/index alias drift each observe red before
untouched input restores green.
