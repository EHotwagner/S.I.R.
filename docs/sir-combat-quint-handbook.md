...
<figure class="combat-quint-diagram" data-diagram-embed="state-action"><object type="image/svg+xml" data="assets/sir-combat-quint-interactive/state-action.svg" aria-label="Checked atomic transition from a cohesive pre-state and attack input to a post-state and observation" style="width:100%;aspect-ratio:720/240;display:block"><a href="assets/sir-combat-quint-interactive/state-action.svg">Open the interactive transition diagram</a></object><figcaption>Hover either state, the input, enabling check, operation, observation, or transition arrows for details. A checked transition maps one cohesive pre-state and input to one post-state and observation; invalid input disables the operation. <a href="assets/sir-combat-quint-interactive/state-action.svg#effects-off">effects-off view</a></figcaption></figure>
...
the caption link opens the standalone diagram, and the transcript carries the same essential meaning without hover.
...
<figure class="combat-quint-diagram" data-diagram-embed="two-traces"><object type="image/svg+xml" data="assets/sir-visibility-quint/two-traces.svg" aria-label="Parallel lanes compare a four-cell supercover terrain trace with a three-cell sampled boundary trace" style="width:100%;aspect-ratio:960/500;display:block"><a href="assets/sir-visibility-quint/two-traces.svg">Open the two traces diagram</a></object><figcaption>Hover trace headings, paths, grid squares, the opaque terrain, and boundary segments for details. Terrain and boundary permeability consume different grid projections of the same endpoints. <a href="assets/sir-visibility-quint/two-traces.svg#effects-off">effects-off view</a></figcaption></figure>
...
<figure class="combat-quint-diagram" data-diagram-embed="blocker-semantics"><object type="image/svg+xml" data="assets/sir-visibility-quint/blocker-semantics.svg" aria-label="Three grid lanes show an opaque endpoint passing, an opaque interior cell blocking, and an opaque edge blocking" style="width:100%;aspect-ratio:960/450;display:block"><a href="assets/sir-visibility-quint/blocker-semantics.svg">Open the blocker semantics diagram</a></object><figcaption>Hover each rule label, blocker, ray, or result for details. Opacity matters only at the precise interior cell and sampled-edge positions named by the two predicates. <a href="assets/sir-visibility-quint/blocker-semantics.svg#effects-off">effects-off view</a></figcaption></figure>
...
<figure class="combat-quint-diagram" data-diagram-embed="footprint-exposure"><object type="image/svg+xml" data="assets/sir-visibility-quint/footprint-exposure.svg" aria-label="Four paths connect two origin cells to two target cells; one blue path survives three red blockers, making the target visible" style="width:100%;aspect-ratio:960/480;display:block"><a href="assets/sir-visibility-quint/footprint-exposure.svg">Open the footprint exposure diagram</a></object><figcaption>Hover footprint squares, individual pair paths, or the result counter for details. One surviving pair is sufficient: visibility means `visibleSamples &gt; 0`, not that every footprint pair passes. <a href="assets/sir-visibility-quint/footprint-exposure.svg#effects-off">effects-off view</a></figcaption></figure>
...
<figure class="combat-quint-diagram" data-diagram-embed="work-bound"><object type="image/svg+xml" data="assets/sir-visibility-quint/work-bound.svg" aria-label="A four-pair matrix reaches a guard where declared work twelve exceeds maximum eight and returns a truncated result before tracing" style="width:100%;aspect-ratio:960/470;display:block"><a href="assets/sir-visibility-quint/work-bound.svg">Open the work bound diagram</a></object><figcaption>Hover pair entries, admission comparisons, the truncated result, or either work meter for details. The declared sampled-line work controls admission; internal supercover work remains separately visible for review. <a href="assets/sir-visibility-quint/work-bound.svg#effects-off">effects-off view</a></figcaption></figure>
...
<figure class="combat-quint-diagram" data-diagram-embed="evaluator-pipeline"><object type="image/svg+xml" data="assets/sir-visibility-quint/evaluator-pipeline.svg" aria-label="Visibility query flows through footprint pairs, work guard, two line predicates, visible count, and a result record" style="width:100%;aspect-ratio:1120/430;display:block"><a href="assets/sir-visibility-quint/evaluator-pipeline.svg">Open the evaluator pipeline diagram</a></object><figcaption>Hover any pipeline node or transition arrow for details. The functional model introduces no production state; its simulation adapter stores results only to exercise invariants and reachable witnesses. <a href="assets/sir-visibility-quint/evaluator-pipeline.svg#effects-off">effects-off view</a></figcaption></figure>
...
<figure class="combat-quint-diagram" data-diagram-embed="invariant-boundary"><object type="image/svg+xml" data="assets/sir-combat-quint-interactive/invariant-boundary.svg" aria-label="Reachable states remain inside a safety boundary until a mutated transition escapes" style="width:100%;aspect-ratio:720/250;display:block"><a href="assets/sir-combat-quint-interactive/invariant-boundary.svg">Open the interactive safety boundary diagram</a></object><figcaption>Hover the safety region, reachable states, altered transition, escaping edge, or failing state for details. The safety boundary encloses checked reachable states; one mutated transition escapes to a concrete violating path. <a href="assets/sir-combat-quint-interactive/invariant-boundary.svg#effects-off">effects-off view</a></figcaption></figure>
