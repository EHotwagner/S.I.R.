...
printf '%s\n' \
  '<?xml version="1.0" encoding="UTF-8"?>' \
  '<testsuite name="sir-handbook-m6-structure" tests="5" failures="0" errors="0" skipped="0">' \
...
printf '%s\n' \
  ...
  '  <testcase classname="SIR.HandbookM6" name="four-structural-mutations-restored-green"/>' \
  '  <testcase classname="SIR.HandbookM6" name="full-q4-runtime-regression"/>' \
  '  <testcase classname="SIR.HandbookM6" name="roadmap-ledger-only-m6-checked"/>' \
  '  <testcase classname="SIR.HandbookM6" name="sdd-analysis-current-and-implementation-ready"/>' \
  '</testsuite>' > "$receipt_root/qualification.junit.xml"

printf 'handbook-m6 qualification: PASS (strict docs, 188 definitions, 5 aliases, 74 declarations, 16 rules, 50 chapters, 4 mutations, Q4/runtime, roadmap, SDD)\n'
