...
const nonPositiveJudgements = new Map([
  ...
  ["m1-linked-skeleton#1", ["accepted observation", "The bound report accepts the fresh-worktree bootstrap as onboarding friction: locked restore was necessary but not sufficient, and prepare-site-only passed only after the subsequent pinned-host override; this retains the complete measured envelope without attributing a new semantic defect."]],
  ...
  ["m7-publication-handoff#3", ["accepted observation", "The bound report accepts this self-owned one-cycle orchestration error: current issue and route history independently verify that revision 2 added the maintenance path, while the first-write ordering and claim widening remain checkpoint testimony under the audit's confidence limit; no external duplicate exists."]],
