...
- PD-005 [AC-002] [FR-005] complete: The pair fixes a 20x20 CSS-pixel viewport and visible density while increasing global extent, units, and supporting-list scale; summaries retain observed global and live-DOM-by-layer counters separately.
