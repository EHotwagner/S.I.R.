...
- PD-004 [AC-002] [FR-004] [DEC-001] complete: `scripts/svg-pipeline-fixtures.v1.json` declares all six axes and generates canonical maps; the baseline includes an otherwise-identical 10/40 Hz representative pair, dense-overlay, and global-small/global-large paired fixtures.
- PD-005 [AC-002] [FR-005] complete: The pair fixes a 480x320 CSS-pixel viewport, 40 visible units, 40 global units, and 20 Hz event rate while increasing global extent from 20x20 to 40x40 and supporting-list scale from 40 to 800; summaries retain observed global and live-DOM-by-layer counters separately.
...
- PD-010 [AC-005] [FR-010] complete: Focused Node tests cover schema, axis independence, route inventory, receipt-to-tracked-authority digest/candidate binding, unavailable capability, ranking/disposition, and malformed/stale rejection; each new gate receives a subject-mutation demonstration.
