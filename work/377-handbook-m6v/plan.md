...
- checklist: work/377-handbook-m6v/checklist.md sha256:a50d9919c75faa31addd377e32f3d09ab407df471af267d73a1e1e2ccd377e79 schemaVersion:1
...
- PD-006 [AC-006] [FR-006] [DEC-004] complete: Build strict FsDocs, serve the exact site output, and inspect the generated handbook in Chromium across normal/reduced-motion/print/effects-off/CSS-disabled routes for visibility, layout, labels, console/page errors, and screenshots.
...
- PD-008 [AC-008] [FR-008] complete: Generate isolated temporary fixtures for authority, glyph, accessibility, fallback, fingerprint, and structural-budget mutations plus a retained decoded-readiness timing-overflow mutation; assert all seven named detector/red messages, then run untouched input green.
...
- VO-004 [PD-006] [PC-003] renderedInspection: Build strict FsDocs and run real Chromium normal/reduced-motion/print/effects-off/CSS-disabled inspection with 30 standalone screenshots, 18 handbook-image screenshots, console/page-error refusal, and all-six-visible assertions.
...
- VO-006 [PD-008] mutationTest: Observe six static named red mutations plus the retained in-subject timing-overflow red, with untouched restored green using disposable fixtures and live replay storage.
...
- workloadDefinitionDigests: [handbook-m6v-six-diagram-render-v1=sha256:158170af5de2d37e3d10982e2bdce2dc25cb13cfb9c7d76b186f1cef6a51a86b]
...
- renderModes: [normal, reduced-motion, print, effects-off, css-disabled]
- warmupNavigations: 3
- sampleCount: 100
