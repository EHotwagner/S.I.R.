...
jq -e '.outcome == "noChange" and .coherent == true and all(.changedArtifacts[]; .operation == "noChange") and .analysis.status == "implementationReady" and .analysis.readiness == "implementationReady" and .analysis.sourceCount == 9 and .analysis.sourceRelationshipCount == 82 and .analysis.readyFindingCount == 82 and .analysis.advisoryCount == 0 and .analysis.warningCount == 0 and .analysis.blockingCount == 0 and .analysis.staleSourceCount == 0 and .analysis.missingDispositionCount == 0 and .analysis.malformedSourceCount == 0 and .analysis.generatedViewFindingCount == 0 and .analysis.acceptedDeferralCount == 0 and .diagnostics == []' "$initial_analysis_report" >/dev/null
...
jq -e '.outcome == "noChange" and .coherent == true and all(.changedArtifacts[]; .operation == "noChange") and .analysis.status == "implementationReady" and .analysis.readiness == "implementationReady" and .analysis.sourceCount == 9 and .analysis.sourceRelationshipCount == 82 and .analysis.readyFindingCount == 82 and .analysis.advisoryCount == 0 and .analysis.warningCount == 0 and .analysis.blockingCount == 0 and .analysis.staleSourceCount == 0 and .analysis.missingDispositionCount == 0 and .analysis.malformedSourceCount == 0 and .analysis.generatedViewFindingCount == 0 and .analysis.acceptedDeferralCount == 0 and .diagnostics == []' "$analysis_report" >/dev/null
