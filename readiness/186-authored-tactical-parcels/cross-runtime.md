...
The exact comparison passed over all 1,094 canonical bytes. Both runtimes emitted
content identity
`18750a88acda3674081cd7de290600005fbc36cfcf8da44a34b7bf95c4bc87fd`.
This receipt supersedes the pre-repair 982-byte observation: repair-round
schema work added feature cell volumes and embedded the full authored-catalog
assembly identity. Schema v1 now defines that assembly identity as SHA-256 over
a domain-tagged, length-prefixed binary encoding of the complete plot and
variant catalog; the assembled canonical envelope embeds it. The final probe
therefore binds the intended repaired schema rather than preserving stale
generated bytes.
