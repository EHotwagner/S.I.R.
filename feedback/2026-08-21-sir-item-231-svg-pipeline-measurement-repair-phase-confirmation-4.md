...
- **Evidence:** review:https://github.com/EHotwagner/S.I.R./pull/246#issuecomment-5373815756; run:https://github.com/EHotwagner/S.I.R./actions/runs/32513160418; file:scripts/ci-gate-artifact-bindings.sh; command:bash scripts/test-ci-gate-artifact-isolation.sh
...
- **Evidence:** review:https://github.com/EHotwagner/S.I.R./pull/246#issuecomment-5373815756; run:https://github.com/EHotwagner/S.I.R./actions/runs/32513160418; file:tests/SIR.Client.Tests/ScenarioCatalogQualification.fs; command:dotnet run --project tests/SIR.Client.Tests/SIR.Client.Tests.fsproj -c Release --no-restore; command:./scripts/test-browser-wasm-verification.sh
