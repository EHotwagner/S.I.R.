...
changed="scripts/test-conformance.sh;scripts/ci-route.mjs;scripts/test-ci-route.mjs;tests/SIR.Browser.Tests/production-delivery.spec.js;.github/workflows/ci.yml;docs/performance-budget.md;work/231-svg-pipeline-measurement/production-chromium-authority.json;work/231-svg-pipeline-measurement/production-chromium-evidence.json"
