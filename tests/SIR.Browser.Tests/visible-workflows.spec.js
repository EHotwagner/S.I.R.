...
import { tacticalFrameBudget, tacticalOverlayLayerBudget, tacticalWorkloadBudgetAtScale } from "../../scripts/lib/performance-budget.mjs";
...
test("View analysis overlays share pointer and keyboard commands and restore independently", async ({ page }) => {
  ...
  // The overlay-layer node bound was a bare literal here: the ONLY statement of it anywhere, declared
  // in no budget document, gating this browser test and nothing else (S.I.R.#327). It is now DERIVED
