...
import { tacticalFrameBudget, tacticalOverlayLayerBudgetReason, tacticalWorkloadBudgetAtScale } from "../../scripts/lib/performance-budget.mjs";
...
test("View analysis overlays share pointer and keyboard commands and restore independently", async ({ page }) => {
  ...
  // this call site.
  expect(tacticalOverlayLayerBudgetReason({
    countedNodes: await overlayLayer.locator("*").count(),
    reportedEstimate: Number(await battlefield.getAttribute("data-overlay-node-estimate")),
  })).toBeNull();
