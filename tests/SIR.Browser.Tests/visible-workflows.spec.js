...
import { assertTacticalOverlayLayerBudget, tacticalFrameBudget, tacticalWorkloadBudgetAtScale } from "../../scripts/lib/performance-budget.mjs";
...
test("View analysis overlays share pointer and keyboard commands and restore independently", async ({ page }) => {
  ...
  // this call site.
  assertTacticalOverlayLayerBudget({
