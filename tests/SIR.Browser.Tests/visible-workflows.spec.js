...
const overlayBudgetTest = test.extend({
...
overlayBudgetTest("View analysis overlays share pointer and keyboard commands and restore independently", { tag: tacticalOverlayLayerBudgetTag }, async ({ page }) => {
  await page.goto("/");
  const battlefield = page.locator("#persistent-tactical-svg");
